...
class PostDetailView(PermissionRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['current_author'] = getattr(self.request.user, 'author', None) if self.request.user.is_authenticated else None
        return context
...
def create_post(request):
    ...
    if form.is_valid():
        ...
        messages.error(request, 'Failed to create post.', 'danger')
        return render(request, 'blog/post_create_update.html', context={'form': form, 'title': 'Create Post'})
